...
class BaseTransformer:
    ...
    def create_date_key(self, df, date_column, key_date_name = 'xxx_key_date'): 
        ...
        Args:
            ...
            key_date_name (str): The name of the new key column to create. Defaults to 'xxx_key_date'.
        """
        ...
        try:
            if date_column in df.columns:
                ...
                df[key_date_name] = df[date_column].dt.date
                
                self.logger.debug(f"Created date key '{key_date_name}' from '{date_column}'.")
            else:
    ...
    def data_quality_check(self, df, table_name:str, date_columns: list = None, amount_columns: list = None, allow_negative_amounts: bool = False):
        """
        ...
        try:
            ...
            #check datatype
            self.logger.info(f'---Dataframe infor: {df.info}---')
